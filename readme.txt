...
Setup for real time streaming:
    ...
    2. Edit the message boxes for the directory of python, the sensorlog.py, local ip, and port information
    3. Click 'run py host', and check to see if script is running in console
        - Errors from the python file will also appear in the Max console
    4. Make sure the SensorLog app reflects the ip and port you have entered
    5. From SensorLog, enable the following:
        - logging rate: 100Hz
        - log format: , and csv
        - mode: client
        - protocol: ump
    ...
    6. Finally, enable "log to stream" and make sure it connects
